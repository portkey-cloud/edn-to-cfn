...
(do
 ...
 (clojure.spec.alpha/def
  :aws.game-lift/description
  clojure.core/string?)
 (clojure.spec.alpha/def :aws.game-lift/name clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
  :aws.game-lift/fleet
 ...
 (clojure.spec.alpha/def :aws.game-lift/min-size clojure.core/integer?)
 (clojure.spec.alpha/def :aws.game-lift/name clojure.core/string?)
 (clojure.spec.alpha/def :aws.game-lift/max-size clojure.core/integer?)
 (clojure.spec.alpha/def :aws.game-lift/build-id clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
  :aws.game-lift/build
 ...
 (clojure.spec.alpha/def :aws.game-lift/name clojure.core/string?)
 (clojure.spec.alpha/def :aws.game-lift/version clojure.core/string?))
(do
