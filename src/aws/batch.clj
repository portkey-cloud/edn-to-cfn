...
(do
 ...
 (clojure.spec.alpha/def :aws.batch/service-role clojure.core/string?)
 (clojure.spec.alpha/def
  :aws.batch/compute-environment-name
  clojure.core/string?)
 (clojure.spec.alpha/def :aws.batch/state clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
  :aws.batch/job-queue
 ...
 (clojure.spec.alpha/def :aws.batch/priority clojure.core/integer?)
 (clojure.spec.alpha/def :aws.batch/state clojure.core/string?)
 (clojure.spec.alpha/def
...
(do
 ...
 (clojure.spec.alpha/def :aws.batch/type clojure.core/string?)
 (clojure.spec.alpha/def :aws.batch/parameters clojure.core/any?)
 (clojure.spec.alpha/def
  :aws.batch/job-definition-name
  clojure.core/string?))
(do
