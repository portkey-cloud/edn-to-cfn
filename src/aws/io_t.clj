...
(do
 ...
 (clojure.spec.alpha/def :aws.io-t/thing-name clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
  ...
  (clojure.spec.alpha/keys
   ...
   :opt
   []))
 (clojure.spec.alpha/def :aws.io-t/policy-name clojure.core/string?)
 (clojure.spec.alpha/def :aws.io-t/principal clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
 ...
 (clojure.spec.alpha/def
  :aws.io-t/certificate-signing-request
  clojure.core/string?)
 (clojure.spec.alpha/def :aws.io-t/status clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
...
(do
 ...
 (clojure.spec.alpha/def :aws.io-t/policy-document clojure.core/any?)
 (clojure.spec.alpha/def :aws.io-t/policy-name clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
  ...
  (clojure.spec.alpha/keys
   ...
   :opt
   [:aws.io-t/rule-name]))
 (clojure.spec.alpha/def :aws.io-t/rule-name clojure.core/string?))
(do
