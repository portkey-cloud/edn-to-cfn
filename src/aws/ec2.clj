...
(do
 ...
 (clojure.spec.alpha/def :aws.ec2/instance-id clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/nat-gateway-id clojure.core/string?)
 (clojure.spec.alpha/def
  :aws.ec2/network-interface-id
  clojure.core/string?)
 (clojure.spec.alpha/def
 ...
 (clojure.spec.alpha/def
  :aws.ec2/vpc-peering-connection-id
  clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/gateway-id clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/route-table-id clojure.core/string?)
 (clojure.spec.alpha/def
  :aws.ec2/egress-only-internet-gateway-id
  clojure.core/string?))
(do
 ...
 (clojure.core/defmethod
  ...
  (clojure.spec.alpha/keys
   ...
   [:aws.ec2/domain-name
    ...
    :aws.ec2/ntp-servers
    :aws.ec2/tags]))
 (clojure.spec.alpha/def :aws.ec2/domain-name clojure.core/string?)
 (clojure.spec.alpha/def
  :aws.ec2/netbios-node-type
 ...
 (clojure.core/defmethod
  ...
  (clojure.spec.alpha/keys
   ...
   [:aws.ec2/egress
    ...
    :aws.ec2/port-range]))
 (clojure.spec.alpha/def :aws.ec2/rule-action clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/network-acl-id clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/rule-number clojure.core/integer?)
 (clojure.spec.alpha/def :aws.ec2/egress clojure.core/boolean?)
 (clojure.spec.alpha/def :aws.ec2/cidr-block clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/ipv6-cidr-block clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/protocol clojure.core/integer?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
...
(do
 ...
 (clojure.spec.alpha/def :aws.ec2/policy-document clojure.core/any?)
 (clojure.spec.alpha/def :aws.ec2/service-name clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/vpc-id clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
  :aws.ec2/route-table
...
(do
 ...
 (clojure.spec.alpha/def :aws.ec2/peer-owner-id clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/peer-role-arn clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/peer-vpc-id clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/vpc-id clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
  ...
  (clojure.spec.alpha/keys
   ...
   :opt
   []))
 (clojure.spec.alpha/def :aws.ec2/aws-account-id clojure.core/string?)
 (clojure.spec.alpha/def
  :aws.ec2/network-interface-id
  clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/permission clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
  :aws.ec2/vpn-gateway
...
(do
 (clojure.core/defmethod
  ...
  (clojure.spec.alpha/keys
   ...
   :opt
   []))
 (clojure.spec.alpha/def :aws.ec2/dhcp-options-id clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/vpc-id clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
...
(do
 (clojure.core/defmethod
  ...
  (clojure.spec.alpha/keys
   ...
   :opt
   [:aws.ec2/tags]))
 (clojure.spec.alpha/def :aws.ec2/bgp-asn clojure.core/integer?)
 (clojure.spec.alpha/def :aws.ec2/ip-address clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/type clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
...
(do
 ...
 (clojure.spec.alpha/def :aws.ec2/strategy clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
...
(do
 (clojure.core/defmethod
  ...
  (clojure.spec.alpha/keys
   ...
   :opt
   []))
 (clojure.spec.alpha/def :aws.ec2/vpn-gateway-id clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
...
(do
 ...
 (clojure.spec.alpha/def
  :aws.ec2/availability-zone
  clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/additional-info clojure.core/string?)
 (clojure.spec.alpha/def
  :aws.ec2/placement-group-name
  clojure.core/string?)
 (clojure.spec.alpha/def
  :aws.ec2/disable-api-termination
  clojure.core/boolean?)
 (clojure.spec.alpha/def :aws.ec2/monitoring clojure.core/boolean?)
 ...
 (clojure.core/defmethod
  ...
  (clojure.spec.alpha/keys
   ...
   [:aws.ec2/ipv6-addresses
    ...
    :aws.ec2/private-ip-address
    :aws.ec2/ipv6-address-count]))
 (clojure.spec.alpha/def :aws.ec2/interface-type clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/subnet-id clojure.core/string?)
 (clojure.spec.alpha/def
  :aws.ec2/source-dest-check
  clojure.core/boolean?)
...
(do
 ...
 (clojure.spec.alpha/def
  :aws.ec2/amazon-provided-ipv6-cidr-block
  clojure.core/boolean?)
 (clojure.spec.alpha/def :aws.ec2/cidr-block clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/vpc-id clojure.core/string?))
(do
 ...
 (clojure.spec.alpha/def
  :aws.ec2/branch-interface-id
  clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/gre-key clojure.core/integer?)
 (clojure.spec.alpha/def
  :aws.ec2/trunk-interface-id
  clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/vlan-id clojure.core/integer?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
...
(do
 ...
 (clojure.spec.alpha/def :aws.ec2/auto-placement clojure.core/string?)
 (clojure.spec.alpha/def
  :aws.ec2/availability-zone
  clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/instance-type clojure.core/string?))
...
(do
 ...
 (clojure.spec.alpha/def :aws.ec2/size clojure.core/integer?)
 (clojure.spec.alpha/def :aws.ec2/iops clojure.core/integer?)
 (clojure.spec.alpha/def :aws.ec2/auto-enable-io clojure.core/boolean?)
...
(do
 ...
 (clojure.spec.alpha/def
  :aws.ec2/deliver-logs-permission-arn
  clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/log-group-name clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/resource-id clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/resource-type clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/traffic-type clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
  :aws.ec2/eip
 ...
 (clojure.spec.alpha/def :aws.ec2/domain clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/instance-id clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
  ...
  (clojure.spec.alpha/keys
   ...
   :opt
   [:aws.ec2/tags]))
 (clojure.spec.alpha/def :aws.ec2/allocation-id clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/subnet-id clojure.core/string?))
(do
 (clojure.core/defmethod
  cfn-specs/resource-type-spec
  ...
  (clojure.spec.alpha/keys
   ...
   [:aws.ec2/allocation-id
    ...
    :aws.ec2/private-ip-address]))
 (clojure.spec.alpha/def :aws.ec2/allocation-id clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/eip clojure.core/string?)
 (clojure.spec.alpha/def :aws.ec2/instance-id clojure.core/string?)
 (clojure.spec.alpha/def
  :aws.ec2/network-interface-id
  clojure.core/string?)
